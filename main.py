...
# Training settings
parser = argparse.ArgumentParser(description="PyTorch DBPN")
...
parser.add_argument('--train_dir', type=str, default='/home/tmp_data_dir/liuyijiao/super-resolution/DIV_2K/train/train/', help='path to train dir')
parser.add_argument("--scale_factor", type=int, default=8, help="scale factor to use, Default: 8")
def main():
...
def train(training_data_loader, optimizer, model, criterion, epoch):
    ...
    for iteration, batch in enumerate(training_data_loader, 1):
        ...
        input, label_x8 = Variable(batch[0]), Variable(batch[1], requires_grad=False)
        ...
        if iteration%24 == 0:
            print("===> Epoch[{}]({}/{}): Loss: {:.10f}".format(epoch, iteration, len(training_data_loader), loss_x8.data[0]))
